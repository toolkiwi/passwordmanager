...
export default {
    ...
    list_item_content: 'flex-1 flex flex-row items-center truncate',
    ...
    title: 'text-neutral-200 font-semibold text-md max-sm:text-[15px] truncate flex flex-row items-center gap-1.5',
