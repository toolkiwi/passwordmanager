...
export default function RenderFooterLinks() {
    return (
        <div className={CN.container}>
            <a
                href='https://github.com/toolkiwi/passwordmanager'
                target='_blank'
                rel='noreferrer'
            >
                <StyledButton
...
const CN = {
    ...
    button_toolkiwi:
        'grayscale-100 opacity-30 transition-all group-hover:grayscale-0 group-hover:opacity-100',
};
